  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-sm text-gray-500">Join the CoopGig cooperative platform</p>
      </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <p className="mt-1 text-sm font-medium">Hire Workers</p>
            </button>
            <button
              type="button"
            ...
            >
              <span className="text-2xl">🔧</span>
              <p className="mt-1 text-sm font-medium">Work & Earn</p>
            </button>
          </div>
        </div>
